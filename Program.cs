using System;
using System.Linq;
using Nivelacion.Modelo;
using System.Collections.Generic;

namespace Nivelacion
{
    class Program
    {
        ...
        static void BuscarEmpleado()
        {
            ...
            if (Existe(Convert.ToInt32(cedula)))
            {
                ...
                Console.SetCursorPosition(38, 10); Console.WriteLine("Salario: " + myEmpleado.Sueldo);
                Console.SetCursorPosition(38, 11); Console.WriteLine("Dias de vacaciones:" + myEmpleado.Diasvaca);
                Console.SetCursorPosition(38, 12); Console.WriteLine("Vacaciones a Pagar: " + myEmpleado.Diaspagos);
        ...
        static void ListarEmpleados()
        {
           ...
           // Marco();
...

            {
                ...
                Console.SetCursorPosition(35, y); Console.WriteLine(myEmpleado.Sueldo);
                Console.SetCursorPosition(45, y); Console.WriteLine(myEmpleado.Diasvaca);
                Console.SetCursorPosition(55, y); Console.WriteLine(myEmpleado.Diaspagos);
        ...
        /*static void Marco()
        {
            ...
            for (int i = 1; i <= 25; i++)
            {
                ...
                Console.SetCursorPosition(95, i); Console.Write("█");
            }

            Console.SetCursorPosition(1, 1); Console.Write("╔═");
            Console.SetCursorPosition(95, 1); Console.Write("═╗");
